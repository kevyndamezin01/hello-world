...
class Laser_weapons(Scene):
	...
	def enter(self):
		...
		if guess == code:
			...
			print "melting sound as the mechanism is fuses together."
...
class The_bridge(self):
	...
	def enter(self):
		...
		action = raw_input("What do you do with the bomb> ")

		if action == "throw the bomb":
			print "In a panic you throw the bomb at the ground of Gothons"
			print "and make a leap for the door. Right as you drop it a"
			print "Gothon shoots you right in the back killing you."
			print "As you die you see another Gothon frantically try and disarm"
			...
			print "Now that the bomb is placed you can run to the escape pod to"
...
class Escape_pod(self):
	...
	def enter(self):
		...
		print "now need to pic on to take. Some of them could be damaged"
